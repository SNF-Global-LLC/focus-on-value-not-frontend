...
const Dashboard = () => {
  return (
    <PageLayout>
      <SEO 
        title="Dashboard - carbonfactor.io" 
        description="Monitor your carbon footprint and sustainability metrics with carbonfactor.io's comprehensive dashboard."
      />
      <div className="min-h-screen bg-background">
        <div className="container mx-auto px-4 py-8">
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-foreground mb-2">Carbon Dashboard</h1>
            <p className="text-muted-foreground text-lg">Track your sustainability metrics and carbon footprint</p>
          </div>
